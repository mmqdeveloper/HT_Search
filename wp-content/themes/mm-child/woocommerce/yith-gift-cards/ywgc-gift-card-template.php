...
<table cellspacing="0" class="ywgc-table-template">
    ...
    <?php if ( get_option( 'ywgc_shop_logo_on_gift_card_before', 'no' ) == 'yes' ) : ?>
        <tr>
            <td class="ywgc-logo-shop" colspan="2" align="<?php echo get_option( 'ywgc_shop_logo_before_alignment' ) ?>" style="padding-bottom:20px; text-align: center;">
                <?php if( isset( $company_logo_url ) && $company_logo_url  ) {  ?>
                    <img style="max-width: 300px;" src="<?php echo apply_filters( 'ywgc_custom_company_logo_url', $company_logo_url ); ?>"
    ...
    <tr>
        <td class="ywgc-card-product-name" style="float: left; padding-top: 20px;">
            <?php
    ...
    <?php do_action( 'yith_wcgc_template_after_message', $object, $context ); ?>
        ...
        <tr>
            <td>
                ...
                <span class="ywgc-card-code" style="margin: 6px 0;display: inline-block; width: 100%">  <?php echo $gift_card_code; ?></span>
            </td>

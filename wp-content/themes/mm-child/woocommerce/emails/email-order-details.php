...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin-bottom: 25px;" border="1">
	<thead>
		<tr>
	...
	<tfoot>
		<?php
			...
			if ( $order->get_customer_note() ) {
				?><tr>
					<td class="td" scope="row" colspan="3" style="text-align:<?php echo $text_align; ?>;"><?php _e( 'Note:', 'woocommerce' ); ?> <?php echo wptexturize( $order->get_customer_note() ); ?></td>

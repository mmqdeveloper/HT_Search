...
if( ! class_exists( 'mm_textblock' ) )
{
	class mm_textblock extends aviaShortcodeTemplate
	{
		/**
		...
		function shortcode_insert_button()
		{
			...
			$this->config['name']			= __( 'MM Text Block', 'avia_framework' );
			...
			$this->config['shortcode'] 		= 'mm_textblock';
		...
		function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
		{
			...
			//$content 		 .= '<a href="#" class="mm-more-description">more</a>';
			$container_class .= " mm-content-booking-description";
			
			$output  = '';
			$output .= $style_tag;
			$output .= "<section {$meta['custom_el_id']} class='{$section_class}' {$markup_entry}>";

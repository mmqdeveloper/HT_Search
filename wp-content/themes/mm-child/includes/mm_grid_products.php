...
if (!class_exists('avia_sc_mm_grid_products') && class_exists('woocommerce')) {

    class avia_sc_mm_grid_products extends aviaShortcodeTemplate {

        /**
         * Create the config array for the shortcode button
         */
        function shortcode_insert_button() {
            $this->config['name'] = __('MM Grid Products', 'avia_framework');
            ...
            $this->config['shortcode'] = 'avia_sc_mm_grid_products';
            $this->config['tooltip'] = __('Display grid of products', 'avia_framework');
        ...
        function popup_elements() {
            $this->elements = array(
                ...
                array("name" => __("List Products ID", 'avia_framework'),
                    "desc" => __("Input List Product ID", 'avia_framework'),
                    "id" => "id_products",
                    "type" => "input",
                    "std" => ""),
                array(
        ...
        function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "") {
            ...
            if (!empty($atts['id_products'])) {
                $post_id = explode(',', $atts['id_products']);
                $args = array(
                    'posts_per_page' => -1,
                    'post_status' => 'publish',
                    'orderby' => 'post__in',
                ...
                if ($the_query->have_posts()) {
                    ob_start();
                    ?>
                    <div class="products mm-grid-products">
                        <?php
                            ...
                            <div <?php post_class(); ?>>
                                ...
                                <div class="avia_cart_buttons single_button">                                    
                                    ...
                                    if($tag_deal){
                                        ...
                                        echo "<span class='wc-price mm-price-before-sale'><span class='starting-price sss'>from</span> ";
                                    ...
                                    echo "<span class='wc-price'><span class='starting-price sss'>".($tag_deal == true ? 'Now<br />from' : 'from')."</span> ";

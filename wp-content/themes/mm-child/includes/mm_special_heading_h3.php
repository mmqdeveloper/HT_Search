...
if ( !class_exists( 'mm_avia_sc_heading_h3' ) )
{
    class mm_avia_sc_heading_h3 extends aviaShortcodeTemplate{
        ...
        function shortcode_insert_button()
        {
            ...
            $this->config['name']		= __('MM Special Heading H3', 'avia_framework' );
        ...
        function popup_elements()
        {
            ...
            $this->elements = array(
                ...
                array(
                    ...
                    "std" 	=> __("Heading H3", 'avia_framework' ),
                    "type" 	=> "input"),

...
if ( !class_exists( 'mm_special_heading_wishlist_share' ) )
{
    class mm_special_heading_wishlist_share extends aviaShortcodeTemplate{
        ...
        function shortcode_insert_button()
        {
            ...
            $this->config['name']		= __('MM Special Heading (Share & wishlist)', 'avia_framework' );
            ...
            $this->config['shortcode'] 	= 'av_heading_share_wishlist';
        ...
        function popup_elements()
        {
            ...
            $this->elements = array(
                ...
                array(
                    ...
                    "std" 	=> __("Heading H2", 'avia_framework' ),
                    "type" 	=> "input"),
                ...
                array(
                    ...
                    "id" 	=> "style",
                    "type" 	=> "select",
                    "std" 	=> "blockquote modern-quote modern-centered",
        ...
        function editor_element($params)
        {
            ...
            $params['args'] = shortcode_atts(array('tag' => 'h2', 'padding' => '5', 'heading'=>'', 'color'=>'', 'style'=>'', 'custom_font'=>'', 'size'=>'', 'subheading_active' => '', 'subheading_size'=>'', 'custom_class'=>'', 'admin_preview_bg'=>'',
                'av-desktop-hide'=>'',
                'av-medium-hide'=>'',
                'av-small-hide'=>'',
                'av-mini-hide'=>'',
        ...
        function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
        {
            ...
            extract(shortcode_atts(array('tag' => 'h2', 'padding' => '5', 'heading'=>'', 'color'=>'', 'style'=>'', 'custom_font'=>'', 'size'=>'', 'subheading_active' => '', 'subheading_size'=>'', 'margin'=>''), $atts, $this->config['shortcode']));
            ...
            if($heading)
            {
                ...
                $ht_custom_share_product = '';
                $yith_wcwl_add_to_wishlist = '';
                if ( shortcode_exists('ht_custom_share_product') ) {
                    $ht_custom_share_product = do_shortcode('[ht_custom_share_product product_id="' . $post->ID . '" ]') ;
                }
                if ( shortcode_exists('yith_wcwl_add_to_wishlist') ) {
                    $yith_wcwl_add_to_wishlist = do_shortcode('[yith_wcwl_add_to_wishlist product_id="' . $post->ID . '" ]');
                }
                //html markup
                $output .= "<div {$styling} class='ht-style-wishlist-share av-special-heading av-special-heading-{$tag} {$color} {$style} {$class} {$av_display_classes}'>";
                $output .=      $before;
                $output .=      "<{$tag} class='av-special-heading-tag {$av_title_font_classes}' $markup >{$heading}<div class='ht-icon-heading'>{$ht_custom_share_product}{$yith_wcwl_add_to_wishlist}</div></{$tag}>";
                $output .=      $after;

...
if (!class_exists('mm_sc_grid_row')) {

    class mm_sc_grid_row extends aviaShortcodeTemplate {
        ...
        function shortcode_insert_button() {
            $this->config['name'] = __('MM Row', 'avia_framework');
            ...
            $this->config['shortcode'] = 'mm_av_layout_row';
            $this->config['html_renderer'] = false;
            $this->config['tinyMCE'] = array('disable' => "true");
            $this->config['tooltip'] = __('Add Content Row below each other to created advanced grid layout within content area. Cell stylized individually', 'avia_framework');
        ...
        function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "") {
            ...
            $params['id'] = !empty($id) ? $id : "mm-av-layout-grid-" . mm_sc_grid_row::$count;
            ...
            $output .= "<div id='".$params['id']."' class='".$params['class']."'>"; //mm_avia_new_section($params);

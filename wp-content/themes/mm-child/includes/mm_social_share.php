...
//wp_die('test');
if( ! class_exists( 'avia_sc_social_share_custom', false ) )
{
    class avia_sc_social_share_custom extends aviaShortcodeTemplate
    {
        /**
        ...
        function shortcode_insert_button()
        {
            ...
            $this->config['name']			= __( 'MM Social Buttons', 'avia_framework' );
            ...
            $this->config['shortcode'] 		= 'av_social_share_custom';
...
//        }
         ...
         * @since 4.6.4
         */
        public function register_dynamic_templates()
        {
         ...
         * @return array
         */
        public function get_element_styles( array $args )
        {
        ...
        function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
        {
            ...
            $output .= str_replace('rel="noopener"', 'rel="nofollow noopener"', avia_social_share_links( $args, $options, $title, $echo ));
            $output .= '</div>';

...
if ( !class_exists( 'mm_avia_sc_color_section' ) )
{
    class mm_avia_sc_color_section extends aviaShortcodeTemplate{
        ...
        function shortcode_insert_button()
        {
            ...
            $this->config['name']		= __('MM Color Section', 'avia_framework' );

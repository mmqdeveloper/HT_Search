...
class avia_sc_gallery_horizontal extends aviaShortcodeTemplate {
    ...
    function extra_assets() {
        ...
        //load js
        wp_enqueue_script('avia-module-gallery-hor', get_stylesheet_directory_uri()  . '/assets/js/gallery_horizontal.js', array('avia-shortcodes'), false, TRUE);
    }
    ...
    function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "") {
        ...
        if (!empty($attachments) && is_array($attachments)) {
            ...
            foreach ($attachments as $attachment) {
                ...
                $output .= "width='" . $img[1] . "' height='" . $img[2] . "' src='" . $img[0] . "' title='" . $title . "' alt='" . $alt . "' loading='lazy' style='background: grey;'/>";

...
if ( !class_exists( 'mm_avia_sc_heading_h2' ) )
{
    class mm_avia_sc_heading_h2 extends aviaShortcodeTemplate{
        ...
        function shortcode_insert_button()
        {
            ...
            $this->config['name']		= __('MM Special Heading H2', 'avia_framework' );

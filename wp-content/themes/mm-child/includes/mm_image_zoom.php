...
if (!class_exists('avia_sc_image_with_zoom')) {

    class avia_sc_image_with_zoom extends aviaShortcodeTemplate {

        /**
         * Create the config array for the shortcode button
         */
        function shortcode_insert_button() {
            $this->config['name'] = __('Image With Zoom', 'avia_framework');
            ...
            $this->config['shortcode'] = 'av_image_with_zoom';
        ...
        function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "") {
            ...
            if (!empty($src)) {
                ...
                if (is_numeric($src)) {
                    ...
                    $output .= "<div class='mm-image-with-zoom avia-image-container {$class} " . $meta['el_class'] . " " . $this->class_by_arguments('align', $atts, true) . "' $markup >";
                    $output .= "<div class='mm-image-with-zoom-btn-zoom' data-src='{$src}'></div>";
...
if (!function_exists('mm_image_with_zoom_popup_html')) {
    function mm_image_with_zoom_popup_html () {
        $output = '';
        $output .= "<div class='mm-image-with-zoom-popup'>";
        $output .= "<div class='mm-image-with-zoom-popup-overlay'></div>";
        $output .= "<div class='mm-image-with-zoom-popup-inner'>";
        $output .= "<div class='mm-image-with-zoom-popup-btn-close'></div>";
        $output .= "</div>";
        $output .= "</div>";
        echo $output;
    }
    add_action('ava_after_body_opening_tag', 'mm_image_with_zoom_popup_html');
}

				...
				$this->elements = array(
					...
					array(
                        ...
                        array(
									...
									"std" 	=> ""),
					array(
						"name" 	=> __("Tab Image Hover",'avia_framework' ),
						"desc" 	=> __("Either upload a new, or choose an existing image from your media library",'avia_framework' ),
						"id" 	=> "tab_image_hover",
						"type" 	=> "image",
						"fetch" => "id",
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
	            ...
	            if($atts['icon_select'] == "image_top")
	            {
	            	if(!empty($atts['tab_image']))
	            	{
	            		...
	            		$src_hover = wp_get_attachment_image_src($atts['tab_image_hover'], 'full');
						avia_sc_tab_section::$tab_images[ avia_sc_tab_section::$tab ] .= "";
	            		if(!empty($src[0])){
	            	    	avia_sc_tab_section::$tab_images[ avia_sc_tab_section::$tab ] .= "<img class='av-tab-section-image no-hover' src='$src[0]'>";
						}
						if(!empty($src_hover[0])){
							avia_sc_tab_section::$tab_images[ avia_sc_tab_section::$tab ] .= "<img class='av-tab-section-image img-hover' src='$src_hover[0]'>";
						}
					}
				}

...
if (have_posts()) :
    ...
    while (have_posts()) : the_post();
        ...
        $current_post['author'] = get_the_author();
         ...
         * render the html:
         */
        echo "<div class='flex_column av_one_third  flex_column_div av-zero-column-padding el_after_av_textblock  el_before_av_one_third' style='margin-left:1.5%; margin-right:1.5%;'>";
        ...
        if ($blog_global_style !== 'elegant-blog') {
            if (strpos($blog_style, 'big') !== false) {
                ...
                if ($slider)
                    echo '<div class="flex_column av_one_half  flex_column_div av-zero-column-padding first  avia-builder-el-img  el_after_av_heading  el_before_av_one_half  ' . $blog_style . '">' . $slider . '</div>';
            }
        ...
        /*  echo "<div class='blog-meta'>";
          ...
          echo "</div>";
         */
        echo "<div class='flex_column av_one_half  flex_column_div av-zero-column-padding   avia-builder-el-content  el_after_av_one_half  avia-builder-el-last  column-top-marginentry-content-wrapper clearfix {$post_format}-content'>";
        echo '<header class="entry-content-header mm-header">';

...
if ( !class_exists( 'mm_avia_sc_masonry_gallery' ) ) 
{
	class mm_avia_sc_masonry_gallery extends aviaShortcodeTemplate
	{	
			/**
			...
			{
				$this->config['name']			= __('MM Masonry Gallery', 'avia_framework' );
				...
				$this->config['shortcode'] 		= 'mm_av_masonry_gallery';
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				$masonry  = new mm_avia_masonry($atts);
				...
				$output .=  media_avia_new_section($params);
				$output .= $masonry_html;
				...
				$output .= media_avia_new_section(array('close'=>false, 'id' => "after_masonry"));

...
if (!class_exists('woocommerce')) {
    add_shortcode('av_productslider_mm', 'avia_please_install_woo');
    return;
}


if (!class_exists('mm_avia_sc_productslider') && class_exists('woocommerce')) {

    class mm_avia_sc_productslider extends aviaShortcodeTemplate {

        /**
         * Create the config array for the shortcode button
         */
        function shortcode_insert_button() {
            $this->config['name'] = __('MM Product Slider', 'avia_framework');
            ...
            $this->config['shortcode'] = 'av_productslider_mm';
        ...
        function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "") {
            ...
            $slider = new avia_product_slider_mm($atts);
...
if (!class_exists('avia_product_slider_mm')) {

    class avia_product_slider_mm {
        ...
        public function html_list() {
            ...
            if (have_posts()) :
                ...
                while (have_posts()) : the_post();
                    ...
                    echo apply_filters('woocommerce_loop_add_to_cart_link', sprintf('<a %s href="%s" data-product_id="%s" data-product_sku="%s" class="av-catalogue-item %s product_type_%s">%s</a>', $rel, esc_url($cart_url), esc_attr($product_id), esc_attr($product->get_sku()), $ajax_class, esc_attr($product_type), $text
                            ), $product);
        ...
        public function query_entries($params = array()) {
            ...
            if ($params['sort'] == 'dropdown') {
                ...
                if ($orderBY == 'price' || $orderBY == 'title') {
                    $order = "ASC";
                }
            }

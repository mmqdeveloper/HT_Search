...
if (!class_exists('mm_avia_masonry')) {

    class mm_avia_masonry {
        ...
        static function load_more() {
            ...
            $masonry = new mm_avia_masonry($_POST);
            $ajax = true;
        ...
        function html() {
            ...
            foreach ($this->loop as $entry) {
                ...
                if ($this->atts['caption_elements'] != 'none' || !empty($text_add)) {
                    $items .= "<figcaption class='av-inner-masonry-content site-background'><div class='av-inner-masonry-content-pos'><div class='av-inner-masonry-content-pos-content mm_content-pos'><div class='avia-arrow'></div>" . $text_before;
                    ...
                    if (strpos($this->atts['caption_elements'], 'excerpt') !== false && !empty($content)) {
                        ...
                        $items .= "<i class='fa fa-arrows-alt fa-2x' aria-hidden='true' ></i>";
                        $items .= "<div class='av-masonry-entry-content entry-content' {$markup}>{$content}</div>";
                        $items .= "<div class='cls-date'>" . $date . "</div>";
                    }

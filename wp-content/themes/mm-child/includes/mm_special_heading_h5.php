...
if ( !class_exists( 'mm_avia_sc_heading_h5' ) )
{
    class mm_avia_sc_heading_h5 extends aviaShortcodeTemplate{
        ...
        function shortcode_insert_button()
        {
            ...
            $this->config['name']		= __('MM Special Heading H5', 'avia_framework' );
        ...
        function popup_elements()
        {
            ...
            $this->elements = array(
                ...
                array(
                    ...
                    "std" 	=> __("Heading H5", 'avia_framework' ),
                    "type" 	=> "input"),
        ...
        function editor_element($params)
        {
            ...
            $params['args'] = shortcode_atts(array('tag' => 'h5', 'padding' => '5', 'heading'=>'', 'color'=>'', 'style'=>'', 'custom_font'=>'', 'size'=>'', 'subheading_active' => '', 'subheading_size'=>'', 'custom_class'=>'', 'admin_preview_bg'=>'',
                'av-desktop-hide'=>'',
                'av-medium-hide'=>'',
                'av-small-hide'=>'',
                'av-mini-hide'=>'',
        ...
        function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
        {
            ...
            extract(shortcode_atts(array('tag' => 'h5', 'padding' => '5', 'heading'=>'', 'color'=>'', 'style'=>'', 'custom_font'=>'', 'size'=>'', 'subheading_active' => '', 'subheading_size'=>'', 'margin'=>''), $atts, $this->config['shortcode']));

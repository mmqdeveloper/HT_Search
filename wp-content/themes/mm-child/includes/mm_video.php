 ...
 */
if (!class_exists('avia_sc_video_text')) {

    class avia_sc_video_text extends aviaShortcodeTemplate {

        /**
         * Create the config array for the shortcode button
         */
        function shortcode_insert_button() {
            $this->config['name'] = __('MM Video', 'avia_framework');
            ...
            $this->config['shortcode'] = 'av_video_text';
        ...
        function popup_elements() {
            $this->elements = array(
                array(
                    ...
                    "std" => ""),
                array("name" => __("Text", 'avia_framework'),
                    "desc" => __("", 'avia_framework'),
                    "id" => "text_video",
                    "type" => "textarea",
                    "std" => "Click here to add your own text"),
                array(
        ...
        function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "") {
            extract(shortcode_atts(array('src' => '', 'text_video' => '', 'src_1' => '', 'src_2' => '', 'autoplay' => '', 'format' => '', 'height' => '9', 'width' => '16'), $atts, $this->config['shortcode']));
            ...
            if (!empty($output)) {
                ...
                $html = '<div class="maui-snorkeling">';
                $html .= "<div {$style} class='avia-video red-video avia-video-{$format} {$custom_class}' {$markup}>{$output}</div>";
                $html .= '<div class="text-right">' . $text_video . '</div></div>';
                $output = $html;
            }

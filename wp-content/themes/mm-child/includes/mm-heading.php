...
if( ! class_exists( 'avia_mm_sc_heading' ) )
{
	class avia_mm_sc_heading extends aviaShortcodeTemplate
	{
		...
		function shortcode_insert_button()
		{
			...
			$this->config['name']			= __( 'MM Special Heading', 'avia_framework' );
			...
			$this->config['shortcode']		= 'av_mm_heading';
		...
		protected function get_element_styles( array $args )
		{
			...
			$selectors = array(
						...
						'heading-text'		=> "#top .av-special-heading.{$element_id} .av-special-heading-tag",
		...
		function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
		{
			...
			$output  = '';
			$output .= $style_tag;
			$output .= "<div {$meta['custom_el_id']} class='{$container_class} av-mm-special-heading '>";
			$output .= 		$before;
			$output .= 		"<{$tag} class='av-special-heading-tag' $markup >{$link_before}{$heading}{$link_after}</{$tag}>";
			$output .= 		$after;

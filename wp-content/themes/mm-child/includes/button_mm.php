...
if ( !class_exists( 'avia_sc_button_mm' ) ) 
{
	class avia_sc_button_mm extends aviaShortcodeTemplate
	{
			/**
			...
			{
				$this->config['name']		= __('MM Button', 'avia_framework' );
				...
				$this->config['shortcode'] 	= 'av_button_mm';
			...
			function popup_elements()
			{
				$this->elements = array(
					...
					array(	"name" 	=> __("For Developers: Class button", 'avia_framework' ),
							"desc" 	=> __("Apply a custom class to the button", 'avia_framework' )."<br/><br/>".
									   __("", 'avia_framework' ),
				            "id" 	=> "class_button_mm",
				            "type" 	=> "input",
				            "std" => ""),
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
			   ...
			   $atts =  shortcode_atts(array('label' => 'Click me', 
				...
				$class_button_mm 	= $atts['class_button_mm'];
			    ...
			    $output  = "";
				$output .= "<a href='{$link}' class='{$class_button_mm} avia-button {$extraClass} ".$this->class_by_arguments('icon_select, color, size, position' , $atts, true)."' {$blank} {$style} >";
				$output .= $content_html;
				$output .= "</a>";

...
if( ! class_exists( 'avia_sc_slider_zoom' ) )
{
	class avia_sc_slider_zoom extends aviaShortcodeTemplate
	{
		/**
		...
		function shortcode_insert_button()
		{
			...
			$this->config['name']			= __( 'MM Easy Slider Zoom', 'avia_framework' );
			...
			$this->config['shortcode'] 		= 'mm_slideshowzoom'; //av_slideshow
			$this->config['shortcode_nested'] = array( 'mm_slide' );//av_slide
